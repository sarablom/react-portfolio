	...
	return (
		<>
			...
			<SectionWrapper id="experience">
				...
				<p>
					I'm a fullstack developer, with focus on frontend. My main languages
					are <span>JavaScript</span> and <span>TypeScript</span> and I've
					mainly been working with <span>React, NodeJS</span> and{" "}
					<span>Express</span>. I have experince with <span>NoSQL</span> and
				...
				<p>
					I've been working in Scrum and Kanban teams for several years,so I
					know a lot about agile team work. I'm great at keeping a good
					relationship with both customers and team members.
				</p>
